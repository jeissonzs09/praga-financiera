...
<div class="max-w-7xl mx-auto bg-white p-8 rounded shadow">
    ...
    <form action="{{ route('clientes.store') }}" method="POST" class="form-2cols" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            ...
            <div class="section-grid">
                <input type="text" name="telefono_trabajo" placeholder="Teléfono trabajo" class="span-2 border rounded px-3 py-2">
    ...
    <small class="text-gray-500">Solo formato PDF.</small>
        ...
        <div class="space-y-6">
            ...
            <div class="section-grid">
                ...
                <input type="text" name="hijos" placeholder="Hijos" class="border rounded px-3 py-2">
                <input type="text" name="hijas" placeholder="Hijas" class="border rounded px-3 py-2">
